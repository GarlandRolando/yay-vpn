...
public final class MainActivity extends Activity {
    ...
    private void updateStatus(){
        ...
        stateTitle.setText(stopping?t("Disconnecting…","正在断开…","Memutuskan…"):connecting?t("Connecting…","正在连接…","Menghubungkan…"):healthy?t("Connected","已连接","Terhubung"):on?t("VPN active","VPN 已启动","VPN aktif"):t("Disconnected","未连接","Terputus"));
        stateTitle.setTextColor(healthy?GREEN:INK);
        stateHint.setText(choosing?t("Testing for up to 12 seconds. Tap to cancel.","最多测试12秒。点击取消。","Menguji hingga 12 detik. Ketuk untuk batal."):stopping?t("Releasing VPN connection…","正在释放 VPN 连接…","Melepas koneksi VPN…"):connecting?t("Checking VPN internet access. Tap to cancel.","正在验证 VPN 网络访问。点击取消。","Memeriksa akses internet VPN. Ketuk untuk batal."):on&&!healthy?t("Internet check unavailable. Try a website, or tap to disconnect.","网络检查不可用。请尝试打开网页，或点击断开。","Pemeriksaan internet tidak tersedia. Coba buka situs, atau ketuk untuk memutuskan."):healthy?t("Tap to disconnect","点击断开连接","Ketuk untuk memutuskan"):YayVpnService.failed?YayVpnService.message:t("Tap the power button to connect","点击电源按钮连接","Ketuk tombol daya untuk terhubung"));
